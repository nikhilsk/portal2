...
if(!isset($_SESSION['name']))
{
 ...
 { // if save button on the form is clicked
    ...
    $web= mysqli_real_escape_string($conn, $_REQUEST['wlink']);
        ...
        if (move_uploaded_file($file, $destination)||$file==NULL)
         {
          ...
          $nameofteacher=$_SESSION['name'];
            $sql = "insert into resources (id,category, filename, file, filesize, descrip, drivelink, link, uploader) values ('$newid','webinars', '$topic', '$filename', '$size', '$mess' , '$driv', '$web','$nameofteacher')";
...
<html lang="en">
  ...
  <div class="column is-two-fifths">
    ...
    <div class="m-6">
    <a href="./webinarupload.php" class="button is-fullwidth is-outlineds is-info">Webinars</a>
    </div>
  ...
  <div class="card m-4">
    ...
    <form action="webinarupload.php" method="post" enctype="multipart/form-data">
                    ...
                    <label class="label">Webinar Link</label>
                    <div class="field">
                        <div class="control">
                             <input class="input is-info" type="text" placeholder="Info input" name="wlink">
                         </div>
                    </div>
