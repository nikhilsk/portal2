...
//   include 'abcd.php';
  ...
  if(isset($_POST['search']) or isset($_SESSION['search']))
  {
	...
	$start = ($page - 1) * $limit;
      ...
      $result1 = mysqli_query($conn,"SELECT count(id) AS id FROM resources where filename LIKE '%$string%' and category='research'  ");
  ...
  <?php foreach($records as $row) :  ?>  
    ...
    ?></th>
      ...
      <th><?php echo $row['uploader'] ?></th>
        ...
        <?php endif; ?>
        <th><button class="button is-link is-outlined button is-primary modal-" data-target = "#modal" onClick="fun(this,'<?php echo $row['id'];?>');">View Details</button></th>
