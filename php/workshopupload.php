...
<html lang="en">
  ...
  <body>
  <?php include 'navbarup.php'; ?>
    <div class="columns">
  <div class="column is-two-fifths">
    <br><br><br>
    <div class="m-6 ">
    <a href="./workshopupload.php" class="button is-fullwidth is-outlineda is-link">Workshops</a>
    </div>
    <div class="m-6">
  ...
  <div class="card m-4">
    ...
    <form action="workshopupload.php" method="post" enctype="multipart/form-data">
...
<label class="label">Upload File</label><br>

<div id="file-js-example" class="file is-info is-boxed has-name is-centered">
  <label class="file-label">
    <input type="file" class="file-input" name="myfile" >
    <span class="file-cta">
