...
//   include 'abcd.php';
  ...
  if(isset($_POST['search']) or isset($_SESSION['search']))
  {
	...
	$start = ($page - 1) * $limit;
      ...
      $result1 = mysqli_query($conn,"SELECT count(id) AS id FROM resources where filename LIKE '%$string%' and category='projects'  ");
...
{
echo "<a href='uppro.php' class='button is-black' style='margin-left:1vw;margin-top:0vh;'>My Uploads</a>";
