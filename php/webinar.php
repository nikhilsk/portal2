...
//   include 'abcd.php';
  ...
  if(isset($_POST['search']))
  {
    //   echo $_POST['search'];
      ...
      $result=$conn->query("Select * from resources where filename LIKE '%$string%' and category='webinars'");
      $records=$result->fetch_all(MYSQLI_ASSOC);
      $result1 = $conn->query("SELECT count(id) AS id FROM resources where filename LIKE '%$string%' and category='webinars'");
 ...
 {
  $rid=$z['id'];
  $new=mysqli_query($conn, "select * from resources where id=$rid and category='webinars'");
